...
vcom -2008 tb/tb_dynamic_branch.vhd
...
# Run All Tests
foreach tb {tb_processor tb_phase2_regression tb_dynamic_branch tb_test1 tb_test2 tb_test3 tb_test4 tb_test6 tb_ta_test} {
    vsim work.$tb
    
    # Add waves for the current test
    add wave -divider "Processor State: $tb"
    catch {add wave -radix hex /dut/*}
